...
function App() {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: 'Merhaba! Ben MTM AI (Llama 3.3), size nasıl yardımcı olabilirim?', reasoning: '' }
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Basic extraction of thought process if available (Ollama might implement this differently later)
      // For standard Llama 3.3 chat, it's usually just content, but keeping logic for future compatibility
